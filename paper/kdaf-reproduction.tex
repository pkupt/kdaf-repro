...
\author{Kevin Zhang\\
  \small Independent Researcher (Peking University alumni)\\
...
\subsection{Environment Adaptations (REPRO-ADAPT)}
...
\midrule
KDAF (graph\_ontology) & \textbf{0.5147} & \textbf{0.5147} & 0.1241 & 0.1103 \\
